...
public class TelaEnviarEmail extends JFrame {
	...
	public TelaEnviarEmail() {
		...
		caixaDestinatario.setBounds(100,20,180,20);
		painelEntrada.add(caixaDestinatario);
		...
		botaoEnviar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				usuario.setNome(caixaDestinatario.getText());
				caixaMensagem.setText("");
				caixaDestinatario.setText("");
				try {
				...
				try {
					...
					JOptionPane.showMessageDialog(null,"Email enviado com sucesso","Email enviado com sucesso",JOptionPane.PLAIN_MESSAGE);
					dispose();
